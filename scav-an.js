...
// @include           https://aec1.tribalwars.ae/game.php?t=*&village=*&screen=place&mode=*
  // @include         https://aec1.tribalwars.ae/game.php?village=*&screen=place&mode=*
  // @include              https://aec1.tribalwars.ae/game.php?village=*&screen=overview
...
(async (ModuleLoader) => {
    ...
    loadModule: moduleName => {
        return new Promise((resolve, reject) => {
         ...
         https://www.google.com/s2/favicons?sz=64&domain=userscript.zone
// @grant        none
// ==/UserScript==
